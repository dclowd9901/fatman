...
EntityEarthquake = ig.Entity.extend({
  ...
  sounds : {
    quake : new ig.Sound('media/sounds/quake.ogg')
  },

	init: function( x, y, settings ) {
		this.resetTimer = this.quakeTimer = new ig.Timer();
    this.sounds.quake.volume = .3;
		var _this = this;
        ...
        _this.sounds.quake.play();
				_this.events.trigger('quakeStart', { direction : _this.collisionDirection });
			}
